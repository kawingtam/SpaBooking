...
create table public.products (
    ...
    image_zoom numeric(3,2) not null default 1 check (image_zoom between 1 and 2),
    image_x numeric(5,2) not null default 50 check (image_x between 0 and 100),
    image_y numeric(5,2) not null default 50 check (image_y between 0 and 100),
